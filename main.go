...
func (m *Model) initLists(width, height int) {
	...
	m.lists[todo].SetItems([]list.Item{
		...
		Task{status: todo, title: "eat dinner", description: "home made pizza"},
		Task{status: todo, title: "wash grapes", description: "cause they're great"},
	})

	// Init In Progress
	m.lists[inProgress].Title = "In Progress"
	m.lists[inProgress].SetItems([]list.Item{
		Task{status: inProgress, title: "finish tutorial", description: "CLI Kanban board"},
	})

	// Init Done
	m.lists[done].Title = "Done"
	m.lists[done].SetItems([]list.Item{
		Task{status: done, title: "eat lunch", description: "egg fried rice"},
	})
}
